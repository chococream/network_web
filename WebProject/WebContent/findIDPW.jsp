		...
		<div class="col-lg-4">
			<div class="jumbotron" style="padding-top: 20px">
				<form method="post" action="findIDAction.jsp">
					<h3 style="text-align:center">계정 찾기</h3>
  					<div class="form-group">
  						<input type="text" class="form-control" placeholder="이름" name="userNM" maxlength="20" required>
  					</div>
  					<div class="form-group">
  						<input type="email" class="form-control" placeholder="e-mail" name="userEM" autocomplete="off" checked required>
  					</div>
  					<input type="submit" class="btn btn-primary form-control" value="계정 검색">
				</form>
			</div>
		</div>
	</div>
			...
			<div class="jumbotron" style="padding-top: 20px">
				<form method="post" action="findPWAction.jsp">
					...
					<div class="form-group">
  					...
  					<input type="submit" class="btn btn-primary form-control" value="비밀번호 검색">
				</form>
			</div>
		</div>
	</div>
